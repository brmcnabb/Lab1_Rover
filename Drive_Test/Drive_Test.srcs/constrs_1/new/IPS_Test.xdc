...
##Sch name = JA3
set_property PACKAGE_PIN J2 [get_ports {BkB}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {BkB}]
##Sch name = JA4
set_property PACKAGE_PIN G2 [get_ports {FwA}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {FwA}] 
##Sch name = JA7
set_property PACKAGE_PIN H1 [get_ports {BkA}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {BkA}] 
##Sch name = JA8
set_property PACKAGE_PIN K2 [get_ports {FwB}]					
